---
name: "nvsx-test-verifier"
description: "Xác minh coverage và chất lượng test. Kiểm tra sự tồn tại của test, coverage yêu cầu và kịch bản, xử lý edge case và các pattern chất lượng test."
model: "opus"
color: "purple"
---
