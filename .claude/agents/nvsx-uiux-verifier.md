---
name: "nvsx-uiux-verifier"
description: "Xác minh chất lượng UI/UX của triển khai. Kiểm tra accessibility, nhất quán design token, hành vi responsive, trạng thái component và luồng người dùng UI."
model: "opus"
color: "purple"
---
